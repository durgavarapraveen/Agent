# AntiGravity System Architecture — LEGACY

> ⚠ **This is a legacy architecture doc kept for historical reference.**
> The canonical, up-to-date architecture is at [ARCHITECTURE.md](ARCHITECTURE.md).
> This file is kept because it contains the older UI/API integration diagram
> not yet folded into the canonical doc.
